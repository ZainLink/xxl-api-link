        ...
        <section class="content">
                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn btn-default btn-xs" type="button"
                                    onclick="javascript:window.location.href='${request.contextPath}/group?projectId=${projectId}&groupId=${document.groupId}'">
                                返回接口列表
                            </button>
                        <#if hasBizPermission>
                            <button class="btn btn-default btn-xs" type="button"
                                    onclick="javascript:window.location.href='${request.contextPath}/document/updatePage?id=${document.id}'">
                                修改接口
                            </button>
                        </#if>
                        </div>
                    ...
                    <div class="tab-content no-padding">
                        ...
                        <div class="chart tab-pane active" id="success_resp" style="position: relative; height: 100%;">
                            ...
                            ${document.successRespType}
                                <br>
                                <pre name="successRespExample"
                                     <#if "JSON"==document.successRespType >class="jsonViewPre"</#if>
                                     style="width: 100%; height: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;">${document.successRespExample}</pre>
                            </div>
                        </div>
                        <div class="chart tab-pane" id="fail_resp" style="position: relative; height: 100%;">
                            ...
                            ${document.failRespType}
                                <br>
                                <pre name="failRespExample"
                                     <#if "JSON"==document.successRespType >class="jsonViewPre"</#if>
                                     style="width: 100%; height: 100%; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;margin-top: 15px;">${document.failRespExample}</pre>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <#if responseDatatype?exists>
                <div class="box box-primary">
                    ...
                    <div class="box-body ">
                            ...
                            <#if fieldList?exists && fieldList?size gt 0>
                                <ul style="display: block;">
                                    <#list fieldList as field>
                                        <li>
                                            <span style="font-weight: bold;margin-right: 10px;">${field.fieldName}</span>
                                            {类型：${field.fieldDatatype.name} <#if field.fieldType==1>
                                            []</#if>，描述：${field.fieldAbout}}
                        ...
                        <p>
                            <span style="font-weight: bold;margin-right: 10px;">${responseDatatype.name}
                                :</span> ${responseDatatype.about}
                            <a href="${request.contextPath}/datatype/dataTypeDetail?dataTypeId=${responseDatatype.id}"
                               target="_blank">>>>接口详情</a>
            ...
            <#if document.remark?exists && document.remark?length gt 0 >
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="box-body pad" id="remark"><textarea
                                style="display:none;">${document.remark}</textarea></div>
                    </div>
                </div>
            </#if>
                        ...
                        <#list mockList as mock>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    &nbsp;
                                    <a href="javascript:;" class="updateMock" _id="${mock.id}"
                                       respType="${mock.respType}" style="color: gray;"
                                       onmouseover="this.style.cssText='color:silver;'"
                                       onmouseout="this.style.cssText='color:gray;'"><i class="fa fa-fw fa-wrench"></i>修改</a>
                                    &nbsp;
                                    <a href="javascript:;" class="deleteMock" _id="${mock.id}" style="color:gray;"
                                       onmouseover="this.style.cssText='color:silver;'"
                                       onmouseout="this.style.cssText='color:gray;'"><i class="fa fa-fw fa-trash-o"></i>删除</a>
                                </td>
                            </tr>
                        </#list>
                        </table>
                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <button class="btn btn-info btn-xs" type="button"
                                    onclick="javascript:window.open('${request.contextPath}/test?documentId=${document.id}');">
                                + 接口测试
                            </button>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <#list testHistoryList as testInfo>
                                <tr>
                                    ...
                                    <td>
                                        <a href="${request.contextPath}/test?documentId=${document.id}&testId=${testInfo.id}"
                                           target="_blank">运行</a>
                                        &nbsp;
                                        <a href="javascript:;" class="deleteTest" _id="${testInfo.id}"
                                           style="color:gray;" onmouseover="this.style.cssText='color:silver;'"
                                           onmouseout="this.style.cssText='color:gray;'"><i
                ...
                <form class="form-horizontal form" role="form">
                    <div class="form-group">
                        ...
                        <#list ResponseContentType as item>
                            <input type="radio" class="iCheck" name="respType" value="${item}"
                                   <#if item_index==0>checked</#if>>${item}  &nbsp;&nbsp;
                        </#list>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
                            <textarea name="respExample"
