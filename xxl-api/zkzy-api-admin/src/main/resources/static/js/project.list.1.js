                ...
                "render": function (data, type, row) {
                    return function () {
                        ...
                        if (hasBizPermission(row.bizId)) {
                            ...
                            permissionDiv += '<button class="btn btn-info btn-xs" type="button" onclick="javascript:window.location.href=\'' + goUrl + '\'" >进入项目</button>  ';
                        } else if (hasBizPermission2(row.bizId)) {
                            permissionDiv += '<button class="btn btn-info btn-xs" type="button" onclick="javascript:window.location.href=\'' + goUrl + '\'" >进入项目</button>  ';
                        }
